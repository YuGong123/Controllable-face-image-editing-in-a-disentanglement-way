...
# IMAGE_DATA_DIR = r'D:\PyTorchProjects\FFT-ID-disentanglement-Pytorch-master\data\eval_1000\id_small_image/'
IMAGE_DATA_DIR = r'D:\PyTorchProjects\FFT-ID-disentanglement-Pytorch-master/data/Sample_Dataset_32/small_image/'


Sample_IMAGE_DIR = '../experiment/Test_images_4x4/'
...
test_data_loader = DataLoader(dataset=test_image_dataset, batch_size=4, shuffle=True)
...
# 创建一个空白的画布
torch_figure = torch.empty((1, 3, 1280, 1280), dtype=torch.float32)  # 256*(8+1)=2304
...
# Result!
save_image(torch_figure, "%s/sample_id_attr_4x4.jpg" % (Sample_IMAGE_DIR), normalize=True, range=(0, 1))
